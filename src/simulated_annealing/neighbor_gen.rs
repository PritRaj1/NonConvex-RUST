...
pub struct GaussianGenerator<T: FloatNum, F: ObjectiveFunction<T>, G: BooleanConstraintFunction<T>> {
    pub move_type: MoveType,
    pub prob: OptProb<T, F, G>,
    pub mala_step_size: T,
}

impl<T: FloatNum, F: ObjectiveFunction<T>, G: BooleanConstraintFunction<T>> GaussianGenerator<T, F, G> {
